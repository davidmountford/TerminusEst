...
export default function TacticalOverlayNav({ onSelect, onHome, activeSection = null }) {
    ...
    <>
      <div className="fixed left-4 top-4 z-50 sm:left-6 sm:top-6">
        <button
          ...
          className="group inline-flex items-center gap-2 rounded-md border border-primary/35 bg-cyber-black/78 px-3 py-2.5 font-mono text-[0.62rem] uppercase tracking-[0.24em] text-primary shadow-[0_0_0_1px_rgba(123,47,255,0.12),0_8px_24px_rgba(5,4,10,0.34)] backdrop-blur-md transition-[border-color,background-color,color,transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-secondary/55 hover:bg-cyber-black/88 hover:text-secondary hover:shadow-[0_0_0_1px_rgba(0,229,204,0.14),0_12px_28px_rgba(5,4,10,0.42)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/70"
        >
      ...
      >
        <button
          ...
          className={cn(
            'absolute inset-0 bg-cyber-black/70 backdrop-blur-sm transition-opacity duration-200',
        ...
        <section
          ...
          className={cn(
            'absolute inset-x-4 left-4 top-18 origin-top-left rounded-[1.4rem] border border-primary/30 bg-[linear-gradient(180deg,rgba(38,34,48,0.96),rgba(26,23,33,0.98))] p-4 shadow-[0_0_0_1px_rgba(168,85,247,0.12),0_18px_56px_rgba(5,4,10,0.5),0_0_40px_rgba(123,47,255,0.1)] transition-[opacity,transform] duration-200 sm:inset-x-auto sm:left-6 sm:top-22 sm:w-[22rem] sm:p-5',
